...
const CheckoutPage = ({totalBill}) => {
  return (
    <>
        {/* <Outlet /> */}
       <div className="container">
  <h1 className="h3 mb-5">Payment / Shipping Detail</h1>
  <div className="row">
    {/* Left */}
      ...
      <div className="card position-sticky top-0">
        <div className="p-3 bg-light bg-opacity-10">
          ...
          {/* <div className="d-flex justify-content-between mb-1 small">
            <span>Subtotal</span> <span>Rs. 214.50</span>
          </div>
          <div className="d-flex justify-content-between mb-1 small">
            <span>Shipping</span> <span>Rs. 20.00</span>
          </div>
          <div className="d-flex justify-content-between mb-1 small">
            <span>Coupon (Code: NEWYEAR)</span> <span className="text-danger">-Rs. 10.00</span>
          </div> */}
          <hr />
          <div className="d-flex justify-content-between mb-4 small">
            <span>TOTAL</span> <strong className="text-dark">Rs. {totalBill}</strong>
          </div>
          <div className="form-check mb-1 small">
            <input className="form-check-input" type="checkbox" defaultValue id="tnc" />
            <label className="form-check-label" htmlFor="tnc">
              Cash <a href="#">on Delivery only</a>
            </label>
          </div>
          <div className="form-check mb-1 small">
            <input className="form-check-input" type="checkbox" defaultValue id="tnc" />
