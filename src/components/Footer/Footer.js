  ...
  <div className="container">
    <div className="row">
      <div className="col-lg-3 col-md-6">
        ...
        <section className="widget widget-light-skin">
          <h3 className="widget-title  px-2">Get In Touch With Us</h3>
          <p className="text-white  px-2">Phone: 00 33 169 7720</p>
      ...
      <div className="col-lg-3 col-md-6">
        {/* Mobile App Buttons*/}
        <section className="widget widget-light-skin">
          <h3 className="widget-title  px-2">Our Mobile App</h3><a className="market-button apple-button mb-light-skin ms-3" href="#"><span className="mb-subtitle">Download on the</span><span className="mb-title">App Store</span></a><a className="market-button google-button mb-light-skin ms-3" href="#"><span className="mb-subtitle">Download on the</span><span className="mb-title">Google Play</span></a><a className="market-button windows-button mb-light-skin ms-3" href="#"><span className="mb-subtitle">Download on the</span><span className="mb-title">Windows Store</span></a>
        </section>
      </div>
      <div className="col-lg-3 col-md-6">
        {/* About Us*/}
        <section className="widget widget-links widget-light-skin">
          <h3 className="widget-title px-2">CUSTOMER CARE</h3>
          <ul >
      ...
      <div className="col-lg-3 col-md-6">
        ...
        <section className="widget widget-links widget-light-skin">
          <h3 className="widget-title px-2">INFORMATION</h3>
          <ul>
    ...
    <div className="row">
      ...
      <div className="col-md-5 padding-bottom-1x">
        ...
        {/*Subscription*/}
        <form className="subscribe-form px-3" action="#" method="post" target="_blank" noValidate>
